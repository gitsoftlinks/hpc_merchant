...
class SelectLocationBottomSheet {
  SelectLocationViewModel get viewModel => sl();

  Future show() async {
    var headingStyle = Theme.of(navigatorKeyGlobal.currentContext!)
        .textTheme
        .displayLarge!
    ...
    return showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (context, myState) {
          viewModel.refreshState = () => myState(() {});
          return GestureDetector(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: [
                  locationPicker(context, headingStyle, myState),
                ],
              ),
            ),
          );
  ...
  Stack locationPicker(
      BuildContext context, TextStyle headingStyle, StateSetter myState) {
    bool isFocused = false;

    bool shouldShowBlueColor() =>
        viewModel.selectedLocationController.text.isNotEmpty;
    return Stack(
      children: [
        Align(
                ...
                child: Builder(builder: (context) {
                  return GoogleMap(
                    ...
                    onTap: (LatLng latLng) async {
                      ...
                      print("City Name: ${viewModel.cityName}");
                      myState(() {});
                    },
                      ...
                      children: <Widget>[
                          ...
                          child: IconButton(
                              ...
                              onPressed: () async {
                                final GoogleMapController controller =
                                    await viewModel.googleMapCompleter.future;
                                ...
                                controller.animateCamera(
                                  CameraUpdate.newCameraPosition(
                                    CameraPosition(
                                      target:
                                          LatLng(viewModel.lat, viewModel.long),
                        ...
                        Flexible(
                          child: IconButton(
                              ...
                              onPressed: () async {
                                viewModel.interestArea.value = null;
                                final GoogleMapController controller =
                                    await viewModel.googleMapCompleter.future;
                                var currentZoomLevel =
                                    await controller.getZoomLevel();
          ...
          child: SizedBox(
            ...
            child: OutlinedButton(
              onPressed: () async {
                ...
                await viewModel.googleMapCompleter.future.whenComplete(() {
          ...
          child: Padding(
            ...
            child: TypeAheadFormField(
              ...
              onSuggestionSelected: (Prediction prediction) async {
                ...
                viewModel.selectedLocationController.text =
                    prediction.description;

                await viewModel.updateGoogleMapWithPlaceId(prediction.placeId);
                print('Searched city name : ${viewModel.cityName}');
              ...
              textFieldConfiguration: TextFieldConfiguration(
                ...
                decoration: InputDecoration(
                    ...
                    isDense: true,
                    hintText: 'Select Location'.ntr(),
                    labelText: 'Select Location'.ntr(),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Move marker to select location'.ntr(),
