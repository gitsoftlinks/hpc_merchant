...
class InsertEmailForgetPasswordScreen extends StatelessWidget {
  const InsertEmailForgetPasswordScreen({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: const SafeArea(
            child: Scaffold(
              ...
              body: InsertEmailForgetPasswordScreenContents(),
            ),
          ),
        ),
      ),
...
class InsertEmailForgetPasswordScreenContents extends StatefulWidget {
  const InsertEmailForgetPasswordScreenContents({Key? key}) : super(key: key);

  @override
  State<InsertEmailForgetPasswordScreenContents> createState() => _InsertEmailForgetPasswordScreenContentsState();
}

class _InsertEmailForgetPasswordScreenContentsState extends State<InsertEmailForgetPasswordScreenContents> {
  ...
  void initState() {
    ...
    context.read<ForgetPasswordViewModel>().toggleShowLoader = () => showLoader.toggle();
    context.read<ForgetPasswordViewModel>().errorMessages = (message) => showErrorToast(context, message);
    context.read<ForgetPasswordViewModel>().successMessage = (message) => showSuccessToast(context, message);
  }
