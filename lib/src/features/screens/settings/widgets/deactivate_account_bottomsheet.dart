...
class DeactivateAccountBottomSheet {
    ...
    return showModalBottomSheet(
      ...
      builder: (builder) {
        ...
        return StatefulBuilder(builder: (context, myState) {
          ...
          viewModel.closeBottomSheet = () => Navigator.of(navigatorKeyGlobal.currentContext!).pop();
                ...
                child: Wrap(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text('deactivate_account_bottom_sheet_msg'.ntr(), style: Theme.of(navigatorKeyGlobal.currentContext!).textTheme.headline5!.copyWith(fontWeight: FontWeight.w400, fontSize: 16.sp)),
                    ),
                    SizedBox(
                      height: 20.0.h,
                    ),
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: ContinueButton(
                                ...
                                backgroundColor: viewModel.isAccountActive ? kErrorColor : kPrimaryColor,
                                text: viewModel.isAccountActive ? 'deactivate'.ntr() : 'activate'.ntr(),
                                onPressed: () {
                                  viewModel.toggleIsActiveOrInactiveAccount();
                                },
                              ),
                            ),
                          )
